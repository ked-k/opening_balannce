<div>
    @section('title', 'Expense / Income Types')
                        ...
                        <div class="tab-content">
                            <div class="table-responsive">
                                <table id="datableButton"
                                    class="table table-sm table-borderedtable-bordered table-striped mb-0 w-100 sortable">
                                    ...
                                    <tbody>
                                        @foreach ($expense_types as $key => $expense_type)
                                            <tr>
                                                ...
                                                <td>{{ $expense_type->is_active }}</td>
                                                <td class="table-action">
                                                    <a href="javascript: void(0);" class="action-ico text-success mx-1 "
                                                        data-toggle="modal"
                                                        wire:click="editData({{ $expense_type->id }})"
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="btn-group float-end">
                                        {{ $expense_types->links('vendor.livewire.bootstrap') }}
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end tab-content-->
    ...
    <div wire:ignore.self class="modal fade" id="addnew" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form
                    @if ($toggleForm == 'edit') wire:submit.prevent="updateData" @else  wire:submit.prevent="storeData" @endif>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select name="is_active" class="form-control form-control" wire:model.differ='type'
                                    id="type">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <select name="is_active" class="form-control form-control" wire:model.differ='is_active'
                                    id="is_active">
                                    <option value="">Select...</option>
