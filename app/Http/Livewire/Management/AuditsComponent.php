    ...
    public function storeData()
    {
        ...
        try {
            if ($this->anomaly_image != '') {
                $path = 'MakBRC/Audits/anomalies/' . date("Y-m");
            ...
            if ($this->police_letter_image != '') {
                $path = 'MakBRC/Audits/police/' . date("Y-m");
